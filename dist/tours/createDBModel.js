    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const stepsArray = [
            ...
            },
            {
                ...
                searchString: "findVisibleByMentionAndRoomId(username: IUser['username'], rid: IRoom['_id'], options?: FindOptions<IMessage>): FindCursor<IMessage> {",
                offset: -1,
            },
            {
