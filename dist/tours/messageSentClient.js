    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const stepsArray = [
            ...
            },
            {
                ...
                searchString: '<MessageBox readOnly={readOnly ?? false} key={room._id} tmid={tmid} {...composerProps} showFormattingTips={true} {...props} />',
            },
            {
                title: 'Message Box',
            ...
            },
            {
                ...
                searchString: 'onSend: async ({ value: text, tshow, previewUrls }: { value: string; tshow?: boolean; previewUrls?: string[] }): Promise<void> => {',
            },
        ];
        const steps = yield Promise.all(stepsArray.map(step => (0, utils_1.createStep)(step, tourName)));
        return {
...
exports.default = messageSentClient;
